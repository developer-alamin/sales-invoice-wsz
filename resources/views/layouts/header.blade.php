      ...
      <div class="search-field d-none d-md-block">
        <form class="d-flex align-items-center h-100" action="">
          <div class="input-group">
            ...
            <input type="text" class="form-control bg-transparent border-0" placeholder="{{ __('messages.search_projects')}}">
          </div>
        </form>
      </div>
        ...
        <li class="nav-item nav-profile dropdown">
          <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="nav-profile-text">
              <p class="mb-1 text-black">{{ __('messages.david_greymaax') }}</p>
            </div>
          </a>
        ...
        <li class="nav-item d-none d-lg-block full-screen-link">
         ...
         <li class="nav-item d-none d-lg-block">
          <select name="locale" id="locale" class="form-select">
            ...
            <option value="bn" {{ session('locale', app()->getLocale()) == 'bn' ? 'selected' : '' }}>বাংলা</option>
        </select>
        </li>
